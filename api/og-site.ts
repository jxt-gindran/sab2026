export default function handler(req: any, res: any) {
  ...
  if (requestPath.startsWith("/mission")) {
    ...
    title = "Media Enquiries | SAB 2026";
    description = "Press releases, media kits, interview requests, and official statements from the Sepeda Amal Borneo 2026 expedition. Organized by MMA Foundation.";
  } else if (requestPath.startsWith("/faq")) {
    title = "FAQ | SAB 2026";
    description = "Frequently asked questions about the SAB 2026 charity cycling event, donations, and tax exemption receipts.";
  } else if (requestPath.startsWith("/contact")) {
    title = "Contact Us | SAB 2026";
    description = "Get in touch with the MMA Foundation team for sponsorships, general enquiries, or media contacts for SAB 2026.";
  } else if (requestPath.startsWith("/terms")) {
    title = "Terms & Conditions | SAB 2026";
    description = "Terms and conditions for using the SAB 2026 website and donation platform.";
  } else if (requestPath.startsWith("/privacy")) {
    title = "Privacy Policy | SAB 2026";
    description = "Privacy policy and personal data protection (PDPA) information for the SAB 2026 website and donation platform.";
  } else if (requestPath.startsWith("/refund")) {
    title = "Refund Policy | SAB 2026";
    description = "Refund and cancellation policy for donations made through the SAB 2026 platform.";
  } else if (requestPath.startsWith("/thank-you")) {
    title = "Thank You for Donating | SAB 2026";
    description = "Your generosity directly funds life-saving paediatric care and immune deficiency treatments for children in Borneo.";
  }
...
<head>
    ...
    <meta property="og:site_name" content="Sepeda Amal Borneo 2026" />
