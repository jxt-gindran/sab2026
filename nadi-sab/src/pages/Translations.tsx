...
const EN_FLAT: Record<string, string> = {
  ...
  'home.hero_subtitle': "Funding life-saving surgeries and immune defense for Malaysia's most vulnerable children. Powered by a 680km endurance ride across Borneo.",
  ...
  'home.patient_name': 'Meet Adik Shafeez.',
  'home.patient_age_label': 'Years Old',
  'home.patient_quote': '"Shafeez, from Banting, was a happy boy until an accidental ingestion of a chemical liquid caused severe esophageal stricture — requiring urgent, specialist paediatric surgery to restore his ability to eat and breathe normally."',
  'home.patient_cta': 'Donate to help more kids like Shafeez',
  ...
  'mission.stories_quote': '"Thanks to the paediatric surgery funded by SAB, I can breathe and eat normally again."',
  'mission.stories_name': 'Adik Shafeez, 10',
  'mission.stories_role': 'Severe Esophageal Stricture Survivor',
  'mission.cta_heading': 'These children cannot fight alone.',
  'mission.cta_btn': 'Donate to the Mission',
  'ride.event_date': '26 July - 31 July 2026',
  ...
  'faq.a3': 'Yes. Please contact the MMA Foundation directly at +603-4041 1375 or email mmafoundation1976@gmail.com.',
  ...
  'faq.a7': 'The ride covers approximately 680km from Kota Kinabalu to Miri over 6 days (26 July – 31 July 2026). It includes a mix of coastal roads and rolling hills.',
  ...
  'donate.step3_sub': 'Select your preferred payment method.',
  'donate.step3_hitpay_name': 'Donate Online',
  ...
  'donate.step4_hitpay_heading': 'Ready to Donate.',
  'donate.step4_hitpay_sub': 'Click below to proceed to our secure payment gateway and complete your donation of',
  'donate.step4_proceed': 'Donate Online Now',
  ...
  'donate.step4_hitpay_tab': 'Donate Online',
  ...
  'donate.err_receipt_email': "Please email your receipt to mmafoundation1976@gmail.com with subject 'SAB2026 Manual Receipt' for verification.",
  ...
  'contact.subtitle': "Whether you're a donor, a cyclist, or a supporter, we'd love to hear from you. Reach out to the MMA Foundation team below.",
  ...
  'thankyou.next_step1': 'Official tax-exemption receipt will be issued via email within 30 days of verification.',
  ...
  'modal.close': 'Close',
  'riderstory.cycling_quote': '"Cycling 680km is nothing compared to the fight these children face every day."',
  ...
  'cyclistProfile.loading': 'Loading Profile…',
  'cyclistProfile.load_error': 'Connection Timeout',
  'cyclistProfile.load_error_desc': 'Unable to load this profile. Please check your connection and try again.',
  'cyclistProfile.retry': 'Retry',
  'cyclistProfile.not_found': "This cyclist profile doesn't exist or has been removed.",
  'cyclistProfile.view_all_riders': '← View All Riders',
  'cyclistProfile.back': 'Back',
  'cyclistProfile.sab_rider_label': 'SAB 2026 Rider',
  'cyclistProfile.location_label': 'Borneo 2026',
  'cyclistProfile.goal_label': 'Goal',
  'cyclistProfile.featured_label': 'Featured Rider',
  'cyclistProfile.raised_label': 'Raised',
  'cyclistProfile.reached_suffix': '% Reached',
  'cyclistProfile.their_story': 'Their Story',
  'cyclistProfile.gallery': 'Gallery',
  'cyclistProfile.about_the_ride': 'About The Ride',
  'cyclistProfile.distance_label': 'Distance',
  'cyclistProfile.distance_value': '680 KM',
  'cyclistProfile.days_label': 'Days',
  'cyclistProfile.days_value': '6',
  'cyclistProfile.route_label': 'Route',
  'cyclistProfile.route_value': 'KK → Miri',
  'cyclistProfile.date_label': 'Date',
  'cyclistProfile.date_value': 'Jul 2026',
  'cyclistProfile.support_prefix': 'Support',
  'cyclistProfile.donate_desc': "Your donation directly supports this rider's fundraising goal and funds life-saving paediatric care.",
  'cyclistProfile.donate_now': 'Donate Now',
  'cyclistProfile.or_general_fund': 'Or donate to General Fund',
  'cyclistProfile.share_profile': 'Share Profile',
  'cyclistProfile.link_copied': 'Link Copied!',
  'cyclistProfile.see_all_riders': 'See All Riders',
};
